...
import com.maloy.muzza.constants.YouTubeHistory
...
fun PrivacySettings(
    ...
    val (YouTubeHistoryEnabled, YouTubeHistoryEnabledChange) = rememberPreference(key = YouTubeHistory, defaultValue = false)
    ...
    Column(
        ...
        if (isLoggedIn) {
            SwitchPreference(
                title = { Text(stringResource(R.string.enable_youtube_history)) },
                icon = { Icon(painterResource(R.drawable.history), null) },
                checked = YouTubeHistoryEnabled,
                onCheckedChange = YouTubeHistoryEnabledChange,
            )
        }
