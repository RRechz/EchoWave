...
public class Scheme {
  ...
  private static int onPrimary;
  private static int primaryContainer;
  private static int onPrimaryContainer;
  private static int secondary;
  private static int onSecondary;
  private static int secondaryContainer;
  private static int onSecondaryContainer;
  private static int tertiary;
  private static int onTertiary;
  private static int tertiaryContainer;
  private static int onTertiaryContainer;
  private static int error;
  private static int onError;
  private static int errorContainer;
  private static int onErrorContainer;
  private static int background;
  private static int onBackground;
  private static int surface;
  private static int onSurface;
  private static int surfaceVariant;
  private static int onSurfaceVariant;
  private static int outline;
  private static int outlineVariant;
  private static int shadow;
  private static int scrim;
  private static int inverseSurface;
  private static int inverseOnSurface;
  private static int inversePrimary;
